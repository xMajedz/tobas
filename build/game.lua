...
body "head"
	shape "sphere"
	position {2, 0.82, 5.87}
	radius {0.20}
	density {0.2000}
body "r_pecs"
	shape "sphere"
	position {1.9, 0.9, 5.42}
	radius {0.23}
	density {0.25}
body "l_biceps"
	shape "capsule"
	position {2.52, 0.92, 5.53}
	orientation {0.70710678118655, 0, 0.70710678118655, 0}
	radius {0.12}
	length {0.11}
	density {0.25}
...
body "l_butt"
	shape "sphere"
	position {2.13, 0.92, 4.73}
	radius {0.15}
	density {0.2750}
body "r_foot"
	shape "box"
	position {1.77, 0.85, 3.36}
	sides {0.21, 0.38, 0.10}
	density {0.25}
body "r_butt"
	shape "sphere"
	position {1.87, 0.92, 4.73}
	radius {0.15}
	density {0.2750}
body "l_foot"
	shape "box"
	position {2.23, 0.85, 3.36}
	sides {0.21, 0.38, 0.10}
	density {0.25}
body "l_pecs"
	shape "sphere"
	position {2.1, 0.9, 5.42}
	radius {0.23}
	density {0.25}
body "r_hand"
	shape "box"
	position {0.8, 0.91, 5.56}
	orientation {0.70710678118655, -0.70710678118655, 0, 0}
	sides {0.17, 0.13, 0.16}
	density {0.25}
joint "l_ankle"
