...
body "r_leg"
	...
	orientation {0.99957168190736, -0.026174705665207, -0.013085110093862, -0.00034264566664205}
	radius {0.11}
	length {0.32}
	density {0.25}
body "r_pecs"
...
body "breast"
	...
	orientation {0.48449753881345, 0.51503605202327, 0.48449753881345, -0.51503605202327}
	radius {0.19}
	length {0.15}
	density {0.1000}
body "r_butt"
