...
for k, v in pairs({ l = 1, r = -1 }) do
	...
	joint(k .. "_shoulder")
		...
		altRange { jaltrange.shoulder[k][1], jaltrange.shoulder[k][2] }
	...
	joint(k .. "_hip")
		...
		altVelocity { 650.00 }
		axis { 1.00, 0.00, 0.00 }
		altAxis { 0.00, 1.00, 0.00 }
		range { jrange.hip[k][1], jrange.hip[k][2] }
		altRange { jaltrange.hip[k][1], jaltrange.hip[k][2] }
